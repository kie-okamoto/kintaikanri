...
<div class="list">
  ...
  <div class="list__tabs">
    <a href="{{ route('stamp.list', ['tab' => 'waiting']) }}"
      class="list__tab {{ $tab === 'waiting' ? 'list__tab--active' : '' }}">
      承認待ち
    </a>
    <a href="{{ route('stamp.list', ['tab' => 'approved']) }}"
      class="list__tab {{ $tab === 'approved' ? 'list__tab--active' : '' }}">
      承認済み
    </a>
  </div>
    ...
    <table class="list__table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="{{ route('attendance.show', $request->attendance->id) }}" class="list__link">
              詳細
            </a>
          </td>
        </tr>
